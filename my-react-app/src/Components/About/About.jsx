    ...
    <div className="presentation" id="a-propos">
        ...
        <div className="presentation-container">
            ...
            <div className="logos-competences">
                <figure><img src={logoHtml} className="logo_html" id="logos"></img><figcaption>HTML</figcaption> </figure>
                <figure><img src={logoCss} className="logo_css" id="logos"></img><figcaption>CSS</figcaption></figure>
                <figure><img src={logoJs} className="logo_js" id="logos"></img><figcaption>JavaScript</figcaption></figure>
                <figure><img src={logoSeo} className="logo_seo" id="logos"></img><figcaption>SEO</figcaption></figure>
                <figure><img src={logoReact} className="logo_react" id="logos"></img><figcaption>React</figcaption></figure>
                <figure><img src={logoNode} className="logo_node" id="logos"></img><figcaption>Node.js</figcaption></figure>
                <figure><img src={logoAgile} className="logo-agile" id="logos"></img><figcaption>Agile /scrum</figcaption></figure>
                <figure><img src={logoMongo} className="logo-mongo" id="logos"></img><figcaption>MongoDb</figcaption></figure>
                <figure><img src={logoVite} className="logo-vite" id="logos"></img><figcaption>Vite.js</figcaption></figure>
            </div>
            <h3>Soft Skills</h3>
